    ...
    return Dialog({
        ...
        children: [
            ...
            h('ol', { key: 'steps', class: 'ds-onboard-steps' },
                ...
                h('li', { key: '2' }, h('b', {}, 'Press Claim.'), ' It is the first button on the open report. Claiming puts your name on it so nobody else answers the same person, and the button becomes your name.'),
