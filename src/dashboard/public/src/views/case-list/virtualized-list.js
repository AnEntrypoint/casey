...
const ROW_HEIGHT = 72;      // px, matches .case-row's min-height in app.css
...
export function VirtualizedCaseList({ cases, containerHeight = 560, expandedGuardrails, onToggleGuardrails }) {
  ...
  return h('div', {
    class: 'ds-case-list-scroll', style: 'max-height:' + containerHeight + 'px;overflow-y:auto',
    role: 'list', 'aria-label': 'Cases', ref: refFn, onscroll: onScroll,
  },
    h('div', { key: 'spine', style: 'position:relative;height:' + totalHeight + 'px' },
