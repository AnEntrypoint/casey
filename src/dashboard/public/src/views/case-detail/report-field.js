...
import { Chip, Icon } from '/design/src/components/shell.js';
    ...
    return h('div', { key, class: 'casey-rep-row', 'data-field': k },
        ...
        h('span', { class: 'casey-rep-val' },
            ...
            editing ? h('div', { class: 'casey-rep-edit-actions' },
                h('button', { type: 'button', class: 'casey-rep-save', onclick: save, disabled: savingSet.has(editKey) ? true : null }, savingSet.has(editKey) ? 'Saving...' : 'Save'),
                h('button', { type: 'button', class: 'casey-rep-cancel', onclick: cancelEdit }, 'Cancel')
